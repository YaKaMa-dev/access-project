@extends('welcome')
@section('pageTitle', 'Create Projets')
@section('content')
@if ($errors->any())
...
<div class=" flex items-center justify-center py-8 px-6 sm:px-6 lg:px-10">
    ...
    <div class="max-w-full w-full space-y-6">
      ...
      <div class="rounded-2xl  bg-white max-w-full  overflow-hidden shadow-xl p-8">
        ...
        <form class="space-y-4" action="{{route('projets.store')}}" method="POST">
            @csrf            
          ...
          <div class="rounded-md shadow-sm -space-y-px">
            <div class="grid gap-6">
              <div class="col-span-12">
                ...
                <input type="text" name="project_name" id="project_name" autocomplete="given-name" class="mt-1 p-2  block  w-full shadow-sm sm:text-sm bg-gray-200 text-gray-700 border border-gray-200 focus:bg-white focus:border-gray-500 rounded-md"  value="{{old('libele_projet')}}">
              </div>
            </div>
          </div>
